...
def quick_start_example(file_path: str, target_col: str, problem_type: str):
    ...
    cleaned_df, final_df = pipeline.run_full_pipeline(
        target_col=target_col, problem_type=problem_type, show_eda_plots=True
    )
...
def individual_modules_example(file_path: str):
    ...
    engineer = FeatureEngineer(
        cleaned_df, target_col="your_target", problem_type="classification"
    )
...
def dataframe_example():
    ...
    cleaned_df, final_df = pipeline.run_full_pipeline(
        target_col="target", problem_type="classification", show_eda_plots=False
    )
