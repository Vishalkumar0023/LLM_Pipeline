...
class InstructFormatter:
    ...
    INSTRUCTION_TEMPLATES = [
        ...
        "Extract the product specifications and features from this {domain} listing.",
        "Write a concise product description based on the following {domain} details.",
        "Identify the pros and cons of this product based on the provided {domain} review data.",
        "What are the key selling points of this item according to the {domain} description?",
    ]
    ...
    def _extract_qa_pairs(self, text: str, domain: str) -> List[Dict[str, str]]:
        ...
        for topic in topics[:3]:
            ...
            if relevant:
                ...
                qa_template = self.QA_TEMPLATES[len(pairs) % len(self.QA_TEMPLATES)]
                pairs.append(
                    {
